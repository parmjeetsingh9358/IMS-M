...
export class ChatterComposer extends Component {
    ...
    async sendMessage() {
        ...
        await this.rpc("/mail/chatter_post", this.prepareMessageData());
    ...
    async deleteAttachment(attachment) {
        this.clearErrors();
        try {
            await this.rpc("/portal/attachment/remove", {
...
ChatterComposer.template = "mysisco_complain_register.ChatterComposer";
