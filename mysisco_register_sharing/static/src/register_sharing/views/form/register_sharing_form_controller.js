...
import {RegisterSharingChatterCompiler} from "./register_sharing_form_compiler";
import {ChatterContainer} from "../../components/chatter/chatter_container";

export class RegisterSharingFormController extends FormController {
    setup() {
        super.setup();
        ...
        const mailTemplates = useViewCompiler(
            RegisterSharingChatterCompiler,
            arch,
            {Mail: template},
            {}
        );
...
RegisterSharingFormController.components = {
