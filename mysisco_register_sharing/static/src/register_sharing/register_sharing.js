...
export class RegisterSharingWebClient extends Component {
    setup() {
    ...
    async _showView() {
        const {action_name, register_id, open_task_action} = session;
        console.log("action_name", action_name, register_id);
...
RegisterSharingWebClient.components = {ActionContainer, MainComponentsContainer};
RegisterSharingWebClient.template =
    "mysisco_complain_register.RegisterSharingWebClient";
